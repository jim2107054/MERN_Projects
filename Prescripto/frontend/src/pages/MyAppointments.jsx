          ...
          appointedDoctors.map((item,index)=>(
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b-2' key={index}>
              ...
              <div className='flex-1 my-1 text-base font-light text-zinc-800'>
                ...
                <p className='text-sm font-medium mb-2'>{item.speciality}</p>
                <p className='text-neutral-900 font-medium mt-1'>Address : </p>
                <p className='text-sm'>{item.address}</p>
                <p className='text-sm mt-1'><span className='text-base text-neutral-700 font-medium'>Date & Time : </span>25, May 2025 | 5:00 pm</p>
              </div>
